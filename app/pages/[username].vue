...
const contributorUrl = `soundsters.soundsdesigned.com/${contributor.value?.username}`
  ...
  >
    <div class="flex items-start justify-start w-full h-full pb-8  mb-8">
      <UButton
        ...
        color="neutral"
        class="transition-colors duration-200 text-primary hover:text-primary/80"
            ...
            <div class="flex flex-col items-center gap-4">
              <div class="flex flex-col gap-y-4.5">
                <UButton
                  ...
                  target="_blank"
                  :trailing="true"
                  class="group transition-colors duration-200 hover:bg-primary/50"
                  :ui="{base: 'group', trailingIcon:'text-primary group-hover:text-default'}"
                >
                  <div class="text-2xl">
              ...
              <div class="flex flex-col items-center justify-center text-center gap-y-3">
                ...
                <UModal
                  ...
                  title="Add your Soundster card on Github"
                >
                  <UButton
                    color="primary"
                    variant="subtle"
                  ...
                  <template #body>
                    <div class="flex flex-col gap-y-4">
                      ...
                      <UButton
                        ...
                        @click="copyCard(`[![${contributor?.username} Soundster profile](${ogImageUrl})](https://${contributorUrl})`)"
                      />
                      <p class="text-center">
                        Copy your Soundster card and paste it on your <ULink
